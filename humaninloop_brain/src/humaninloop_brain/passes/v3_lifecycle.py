"""V3 lifecycle — single-DAG operations for StrategyGraph."""
...
from humaninloop_brain.entities.enums import EdgeType, V3_TYPE_STATUS_MAP
...
def update_node_history(
    ...
    for i, node in enumerate(graph.nodes):
        ...
        # Validate status against V3 type-status map
        status_enum = V3_TYPE_STATUS_MAP[node.type]
